...
const mongoose=require('mongoose'),app=require(_0x33db9b(0xb2)),dotenv=require(_0x33db9b(0xa0));
dotenv[_0x33db9b(0xb0)]({'path':'./config.env'});
let DB=process['env'][_0x33db9b(0xa5)];
console[_0x33db9b(0xa1)](DB),mongoose[_0x33db9b(0xaa)](DB)['then'](()=>{const _0x477503=_0x33db9b;console[_0x477503(0xa1)]('DB\x20connection\x20Succesfull');});

function _0x4485(_0x1663e4,_0x4dc1ab)
{const _0x6b7bac=_0x6b7b();return _0x4485=function(_0x4485f2,_0x410498){_0x4485f2=_0x4485f2-0xa0;let _0x5761a5=_0x6b7bac[_0x4485f2];return _0x5761a5;},_0x4485(_0x1663e4,_0x4dc1ab);}

const port=0x1f40;
app[_0x33db9b(0xa8)](port,()=>{const _0x3812db=_0x33db9b;console[_0x3812db(0xa1)](_0x3812db(0xa3)+port);});
